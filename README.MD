...
La concrétisation de son effet prend forme dans une classe dit "abstraite" qui de son nom signifie l'abstaction de détails afin quelle soit "plus tard" redéfini plus pécisemment.
Exemple:
